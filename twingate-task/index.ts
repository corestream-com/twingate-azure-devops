...
async function run() {
  ...
  if (osType == "Windows_NT") {
    ...
    let downloadClient: ToolRunner = tl.tool("powershell").arg(["$ProgressPreference = 'SilentlyContinue';", "Invoke-WebRequest -Uri https://binaries.twingate.com/client/windows/versions/2024.123.6921/TwingateWindowsInstaller.msi -OutFile TwingateWindowsInstaller.msi"]);
